...
<div class="page-content">
    <div class="form-v4-content">
		<form class="form-detail" id="myform" @submit.prevent="handleSubmit()">
			<h2>LOGIN FORM</h2>
			<div class="form-row">
				<label for="your_email">Name</label>
				<input v-model="user.name" type="text" name="your_email" id="your_email" class="input-text">				
 			</div>
			<div class="form-row">
				<label for="your_email">Your Email</label>
				<input v-model="user.email" type="email" name="your_email" id="your_email" class="input-text" required pattern="[^@]+@[^@]+.[a-zA-Z]{2,6}">				
 			</div>
			<div class="form-group">
				<div class="form-row">
					<label for="password">Password</label>
					<input v-model="user.password" type="password" name="password" id="password" class="input-text" required>
				</div>
			</div>
